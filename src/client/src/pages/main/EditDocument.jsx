...
import ChatBox from '../../components/ChatBox'; // ✅ Added ChatBox import
  ...
  return (
    <div className={`container-fluid ${darkMode ? 'bg-dark text-light' : 'bg-light text-dark'} vh-100`}>
      <div className="row h-100">
        {/* Sidebar */}
        <div className={`col-lg-3 col-md-4 col-12 p-3 sidebar ${darkMode ? 'bg-dark text-light' : ''}`} style={{ minWidth: '280px' }}>
          ...
          {/* ChatBox below collaborators */}
          {currentDoc?._id && (
            <div className="mt-4">
              <h5 className={`mb-3 ${darkMode ? 'text-light' : 'text-dark'}`}>Chat</h5>
              <ChatBox roomId={currentDoc?._id} />
            </div>
          )}
        </div>
        ...
        <div className="col-lg-9 col-md-8 col-12 p-4">
          ...
          {/* Editor */}
          <div className="editor-container border rounded p-3 mb-4" style={{ minHeight: '60vh' }}>
            <Editor />
          </div>
        </div>
      </div>
